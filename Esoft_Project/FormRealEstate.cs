...
{
    public partial class FormRealEstate : System.Windows.Forms.Form
    {
        ...
        private void comboBoxType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBoxType.SelectedIndex == 0)
            {
                ...
                labelTotaiFloors.Visible = false;
                textBoxToyalFloors.Visible = false;
            ...
            else if (comboBoxType.SelectedIndex == 1)
            {
                ...
                labelTotaiFloors.Visible = true;
                textBoxToyalFloors.Visible = true;
...

        {
            ...
            {
                realEstate.Type = 1;
                realEstate.TotalFloors = Convert.ToInt32(textBoxToyalFloors.Text);
        ...
        private void listViewRealEstateSet_Apartment_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listViewRealEstateSet_Apartment.SelectedItems.Count == 1)
            {
                ...
                textBoxCoordinate_latitude.Text = realEstateSet.Coordinate_latitude.ToString();
                textBoxCoordinate_longitude.Text = realEstateSet.Coordinate_longitude.ToString();
                textBoxTotalArea.Text = realEstateSet.TotalArea.ToString();
                textBoxRooms.Text = realEstateSet.Rooms.ToString();
                textBoxFloor.Text = realEstateSet.Floor.ToString();
        ...
        private void listViewRealEstateSet_House_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listViewRealEstateSet_House.SelectedItems.Count == 1)
            {
                ...
                textBoxCoordinate_longitude.Text = realEstateSet.Coordinate_longitude.ToString();
                textBoxTotalArea.Text = realEstateSet.TotalArea.ToString();
                textBoxToyalFloors.Text = realEstateSet.TotalFloors.ToString();
            }
            else
            {
                textBoxAddress_City.Text = "";
